...
for i in range(len(names_list)):
    ...
    # use a truetype font  
    font = ImageFont.truetype("./fonts/MLSJN.TTF", 58)      #You can change fonts from list given bottom
    font1 = ImageFont.truetype("./fonts/OLDENGL.TTF", 22) 

    # Draw the text 
    draw.text((int(coordinates[0]), int(coordinates[1])), name_to_print, font=font , fill='#892cdc')
    draw.text((int(coordinates[2]), int(coordinates[3])), date_to_print , font=font1, fill='#590995')
